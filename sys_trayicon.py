...
icon = {
    'on_translation': 'translation.ico',
    'off_translation': 'translationOFF.ico',
    'on_OCR': 'OCRON.ico',
    'off_OCR': 'OCROFF.ico'
}  #<div>Icons made by <a href="https://www.freepik.com" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div>
...
def init_trayicon():
    ...
    menu_options = (('Change Mod (Tlum/OCR)', None, switch_mode), ('ON/OFF (F4)', None, switch_on_off), ('Show flashcard (F4 + Shift)', None, lambda x: showblankcard()), ('Switch Save Path', None, ChangeDirWindow))
    ...
    win = SysTrayIcon(icon['on_translation'], hover_text, menu_options, on_quit=bye, default_menu_index=1)
    return win
